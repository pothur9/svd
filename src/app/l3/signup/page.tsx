...
export default function PersonalDetailsForm() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const verifyResponse = await fetch(`https://2factor.in/API/V1/3e5558da-7432-11ef-8b17-0200cd936042/SMS/VERIFY/${sessionId}/${otp}`);
      ...
      if (verifyData.Status === "Success") {
        ...
        const photoResponse = await fetch("https://api.cloudinary.com/v1_1/dxruv6swh/image/upload", {
          method: "POST",
          body: photoFormData,
        });
        ...
        const response = await fetch("/api/l3/signup", {
          ...
          body: JSON.stringify({
            ...formData,
            photoUrl: photoData.secure_url,  // Ensure you're saving the Cloudinary URL here
    ...
    <div className="bg-gradient-to-b from-slate-50 to-blue-100 min-h-screen py-6 sm:py-10">
      <div className="max-w-lg mx-auto p-4 sm:p-6 bg-white shadow-xl rounded-xl text-gray-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="mailId" className="block text-sm font-semibold">Mail ID</label>
            <input
              type="email"
              name="mailId"
              id="mailId"
          ...
          <div>
            <label htmlFor="karthruGuru" className="block text-sm font-semibold">Karthru Guru</label>
            <input
              type="text"
              name="karthruGuru"
              id="karthruGuru"
          ...
          <div>
            <label htmlFor="peeta" className="block text-sm font-semibold">Peeta</label>
            <input
              type="text"
              name="peeta"
              id="peeta"
          ...
          <div>
            <label htmlFor="bhage" className="block text-sm font-semibold">Bhage</label>
            <input
              type="text"
              name="bhage"
              id="bhage"
          ...
          <div>
            <label htmlFor="gothra" className="block text-sm font-semibold">Gothra</label>
            <input
              type="text"
              name="gothra"
              id="gothra"
          ...
          <div>
            <label htmlFor="presentAddress" className="block text-sm font-semibold">Present Address</label>
            <input
              type="text"
              name="presentAddress"
              id="presentAddress"
          ...
          <div>
            <label htmlFor="permanentAddress" className="block text-sm font-semibold">Permanent Address</label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="qualification" className="block text-sm font-semibold">Qualification</label>
            <select
              name="qualification"
              id="qualification"
          ...
          <div>
            <label htmlFor="languageKnown" className="block text-sm font-semibold">Languages Known</label>
            <input
              type="text"
              name="languageKnown"
              id="languageKnown"
          ...
          <div>
            <label htmlFor="selectedL2User" className="block text-sm font-semibold">Select L2 User</label>
            <select
              name="selectedL2User"
              id="selectedL2User"
          ...
          <div>
            <label htmlFor="photo" className="block text-sm font-semibold">Upload Photo</label>
            <input
              type="file"
              name="photoUrl"
              id="photoUrl"
          ...
          <button
            type="submit"
            className="w-full p-3 bg-blue-500 text-white rounded-md mt-6 hover:bg-blue-600"
          >
            Submit
          </button>
        </form>
          ...
          <div className="bg-white p-6 rounded-xl shadow-xl max-w-sm">
            ...
            <div className="flex space-x-4 mt-4">
              <button
                ...
                className="flex-1 p-3 bg-blue-500 text-white rounded-md hover:bg-blue-600"
              >
                Verify OTP
              </button>
              <button
