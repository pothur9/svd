    ...
    <div >
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              ...
              <li><Link href="/l3/dashboard" className="text-lg">Home</Link></li>
              <li><Link href="/l3/viewevents" className="text-lg">Event Calendar</Link></li>
              <li><Link href="/l3/viewhistory" className="text-lg">History</Link></li>           
              <li><Link href="/l3/generalHistory" className="text-lg">General History</Link></li>
            </ul>
          </div>
      ...
      {totalUsers !== null && (
        <div className=" text-white p-2 text-center ">
          ...
          <Link href="/l3/login" className="btn">
            Logout
          </Link>
        </div>
      </div>
