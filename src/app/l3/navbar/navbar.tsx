...
function Navbar() {
  ...
  return (
    <div>
      <div className="navbar bg-white fixed border-b shadow-sm">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              <li>
                <Link href="/l3/dashboard" className="text-lg">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/l3/viewevents" className="text-lg">
                  Event Calendar
                </Link>
              </li>
              <li>
                <Link href="/l3/viewhistory" className="text-lg">
                  History
                </Link>
              </li>
              <li>
                <Link href="/l3/generalHistory" className="text-lg">
                  General History
                </Link>
              </li>
            </ul>
        ...
        <div className="navbar-end">
          ...
          <Link href="/l3/login" className="btn text-black bg-gray-200">
            Logout
          </Link>
        </div>
      </div>
