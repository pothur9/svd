...
const newNavItems = [
  ...
  {
    label: 'JKayaka',
    href: '/l4/coming-soon?feature=JKayaka+%28Job+Seekers+%26+Donors%29',
    Icon: JKayakaIcon,
  },
  {
    label: 'Samsara Vadhu Vara',
    href: '/l4/coming-soon?feature=Samsara+Vadhu+Vara',
    Icon: SamsaraIcon,
  },
  {
    label: 'Purohita ID',
    href: '/l4/coming-soon?feature=Purohita+ID',
    Icon: PurohitaIcon,
  },
  {
    ...
    <div style={{ position: 'sticky', top: 0, zIndex: 1000, backgroundColor: '#ffffff' }}>
      <div className="navbar shadow-md" style={{ backgroundColor: '#ffffff', color: '#000000', borderBottom: '1px solid #f0f0f0' }}>
        <div className="navbar-start">
          ...
          <Link href="/l4/dashboard" className="btn btn-ghost text-xl">SVD</Link>
        </div>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 flex-nowrap">
            <li>
              <Link href="/l4/dashboard" className="text-sm text-black flex items-center gap-1">
                <HomeIcon /> Home
              </Link>
            </li>
            <li>
              <Link href="/l4/viewevents" className="text-sm text-black flex items-center gap-1">
                <CalendarIcon /> Event Calendar
              </Link>
            </li>
            <li>
              <Link href="/l4/viewhistory" className="text-sm text-black flex items-center gap-1">
                <HistoryIcon /> History
              </Link>
            </li>
            <li>
              <Link href="/l4/generalHistory" className="text-sm text-black flex items-center gap-1">
                <ClipboardIcon /> General History
              </Link>
            </li>
